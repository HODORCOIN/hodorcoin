...
unsigned int nTargetSpacing = 1 * 75; // 75 seconds
...
const string strMessageMagic = "HODORCOIN Signed Message:\n";
...
static const int64_t nTargetTimespan = 20 * 75;  // 20 blocks
//
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HODORCOIN", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "20 June";
        CTransaction txNew;
        txNew.nTime = 1403271330;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x9843d26faf2b5d3a9e33514557181af517d8b17e6a600fa29e424c75ee50d83e"));
